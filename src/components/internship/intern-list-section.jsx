...
import InternshipsContext from "../../state-management/internships/internships-context";
...
export default function InternshipList() {
  const { internships } = useContext(InternshipsContext);
  const { filtered, handleFilterChange, search } = useFilterData(internships, "title");
